...
const Confirm = ({ title, description, time, date, closeModal }) => {
    ...
    return (
        <div className="flex justify-center items-center min-h-full px-20 bg-gradient-to-br from-purple-600 via-pink-500 to-red-500">
            <div className="bg-white/80 backdrop-blur-md shadow-xl rounded-xl p-8 max-w-md w-full text-center border border-white/30 relative">
